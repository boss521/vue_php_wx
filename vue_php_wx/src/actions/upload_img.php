...
//生成目标文件的文件名
	...
	$retArray = array('ret_code' => $ret_code, 'upload_url' => 'http://192.168.1.75/dashboard/moniweixin/vue_php_wx/src/assets/'.$uploadfile, 'upload_resize_url' => 'http://192.168.1.75/dashboard/moniweixin/vue_php_wx/src/assets/'.$uploadfile_resize);
	$retJson = json_encode($retArray);
	echo $retJson;
}
