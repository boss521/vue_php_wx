...
<script>
	export default {
		...
		data() {
			return {
				self_info: {
					header: 'http://192.168.1.53/dashboard/moniweixin/vue_php_wx/src/assets/images/touxiang.jpg',
					user: '',
					name: ''
				},
				actives: [{}]
		...
		mounted: function() {
			...
			this.$http.get('http://192.168.1.53/dashboard/moniweixin/vue_php_wx/src/actions/get_friend_actives.php?user=' + that.self_info.user).then((response) => {
