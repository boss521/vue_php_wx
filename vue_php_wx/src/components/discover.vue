		...
		methods: {
			saoyisao: function() {
				wx.config({
					...
					appId: 'wxa2eac99c5d1a4a28', // 必填，公众号的唯一标识
					timestamp: '1501212', // 必填，生成签名的时间戳
					nonceStr: 'asdf98as7df97sa9d7f8asdf98', // 必填，生成签名的随机串
					signature: '19d7d5fdab8396696049e0f1475e9f0b2329ac67', // 必填，签名，见附录1
					jsApiList: [
						'chooseImage',
						'getNetworkType',
						'scanQRCode'
